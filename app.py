...
def seed_second_property():
    ...
    prop = {
        ...
        'sale_closing_cost_pct': 4.53,
        'contingency_pct': 15.0,
        'partner_split_pct': 50.0,
        'status': 'active',
        'notes': 'Actual sale closing cost: $16,035.12 (4.53%). 4 mortgage payments @ $1,507.98 each. Utilities $67.03. Insurance $843.',
        'holding_costs': {
            'monthly_mortgage': 0,
            'monthly_insurance': 0,
            'monthly_taxes': 0,
        ...
        'expenses': [
            ...
            {'date': '', 'vendor': 'Echols Plumbing', 'description': 'Roof Repair Deposit',               'amount': 750,     'category': 'Roofing',          'is_credit': False},
            {'date': '', 'vendor': 'Echols Plumbing', 'description': 'Roof Repair Final',                 'amount': 750,     'category': 'Roofing',          'is_credit': False},
            {'date': '', 'vendor': 'Echols Plumbing', 'description': 'PICRA Repairs',                     'amount': 470,     'category': 'Labor - General',  'is_credit': False},
            {'date': '', 'vendor': 'Echols Plumbing', 'description': 'PICRA HVAC',                        'amount': 550,     'category': 'Labor - HVAC',     'is_credit': False},
            {'date': '', 'vendor': 'Echols Plumbing', 'description': 'Grass Cutting',                     'amount': 70,      'category': 'Landscaping',      'is_credit': False},
            {'date': '', 'vendor': 'Echols Plumbing', 'description': 'PICRA Repairs 2',                   'amount': 1200,    'category': 'Labor - General',  'is_credit': False},
            {'date': '', 'vendor': 'Staging',         'description': 'Staging Material',                  'amount': 2275,    'category': 'Staging',          'is_credit': False},
            {'date': '', 'vendor': 'Echols Plumbing', 'description': 'Grass Cutting 2',                   'amount': 70,      'category': 'Landscaping',      'is_credit': False},
            {'date': '', 'vendor': 'Echols Contracting','description': 'Final Payment + Final PICRA',     'amount': 1160,    'category': 'Labor - General',  'is_credit': False},
            {'date': '', 'vendor': 'Valentina',       'description': 'Staging Material',                  'amount': 400,     'category': 'Staging',          'is_credit': False},
            {'date': '2026-01-08', 'vendor': 'Utility','description': 'Utilities',                        'amount': 67.03,   'category': 'Utilities',        'is_credit': False},
            {'date': '', 'vendor': 'Insurance',       'description': 'Homeowner Insurance',               'amount': 843,     'category': 'Other',            'is_credit': False},
        ],
        'draws': [],
        'mortgage_payments': [
            {'date': '2026-01-08', 'amount': 1507.98},
            {'date': '2026-02-17', 'amount': 1507.98},
            {'date': '2026-03-16', 'amount': 1507.98},
            {'date': '2026-04-14', 'amount': 1507.98},
        ],
    }
    data['properties'].append(prop)
    save_data(data)
